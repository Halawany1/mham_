                                      ...
                                      itemBuilder: (context, index) => InkWell(
                                        onTap: () {
                                          ...
                                          cubit.getProductDetails(
                                              id: cubit.favoriteProducts[index]
                                                  .productsId!);
                                        ...
                                        child: BuildProductCard(
                                          ...
                                          id: cubit.favoriteProducts[index]
                                              .productsId!,
                                          inCart: cubit.favoriteProducts[index]
                                                  .inCart ??
                                              false,
                                          inFavorite: cubit
                                                  .favoriteProducts[index]
                                              ...
                                              false,
                                          isOffer: cubit
                                              .favoriteProducts[index].isOffer!,
                                          offerPrice: cubit
                                              .favoriteProducts[index]
                                              .offerPrice,
                                          description: cubit
                                              ...
                                              .bcNameEn!,
                                          type: cubit
                                              .favoriteProducts[index].type!,
                                          rate: double.parse(cubit
                                              .favoriteProducts[index]
                                              .averageRate
                                              .toString()),
                                          review: cubit.favoriteProducts[index]
                                              .reviewCount,
                                          price: cubit
                                              .favoriteProducts[index].price!,
                                          title: cubit.favoriteProducts[index]
                                              .productsName!,
                                        ),
                                      ),
                                    )
