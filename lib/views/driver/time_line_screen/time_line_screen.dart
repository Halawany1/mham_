      ...
      child: BlocConsumer<OrderDriverCubit, OrderDriverState>(
        ...
        builder: (context, state) {
          ...
          return Scaffold(
            ...
            body: cubit.timeLineOrderModel == null ||
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      BuildOrderDetails(
                          lenght: cubit.timeLineOrderModel!.activeOrder!
                              .orderItems!.length,
                          createdAt: cubit
                              .timeLineOrderModel!.activeOrder!.createdAt!,
                          status:
                          cubit.timeLineOrderModel!.activeOrder!.status!,
                          totalPrice: double.parse(cubit
                              .timeLineOrderModel!.activeOrder!.totalPrice!
                              .toString())),
                      SizedBox(
                        height: 20.h,
                      ),
                      BuildTrackingOrder(
                          activeProcess: cubit.timeLineOrderModel!.activeOrder!
                              .status == "Ordered" ? 1 :
                          cubit.timeLineOrderModel!.activeOrder!
                              .status == "Processing" ? 2 :
                          cubit.timeLineOrderModel!.activeOrder!
                              .status == "Shipped"? 3:4,
                          shiped: cubit.timeLineOrderModel!.activeOrder!
                              .shippedAt ==
                              null
                              ? true
                              : false,
                          ...
                          createdAt: cubit
                              .timeLineOrderModel!.activeOrder!.createdAt!,
                          orderId: cubit.timeLineOrderModel!.activeOrder!.id!,
                          stepperData: [
                            StepperData(
                                ...
                                subtitle: StepperText(
                                  locale.orderPlaced +
                                      Helper.trackingTimeFormat(cubit
                                          .timeLineOrderModel!.activeOrder!
                                          .createdAt!),
                            ...
                            StepperData(
                                title: StepperText(locale.processing,
                                    textStyle: font.bodyMedium),
                                subtitle: cubit.timeLineOrderModel!.activeOrder!.deliveredAt !=
                                    null &&
                                    cubit.timeLineOrderModel!.activeOrder!
                                        .processingAt !=
                                        null
                                ...
                                iconWidget: Container(
                                  alignment: Alignment.center,
                                  decoration: BoxDecoration(
                                      color: cubit.timeLineOrderModel!.activeOrder!.deliveredAt !=
                                          null ||
                                          cubit
                                              .timeLineOrderModel!.activeOrder!
                                              .processingAt !=
                            ...
                            StepperData(
                                ...
                                iconWidget: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: cubit.timeLineOrderModel!.activeOrder!.deliveredAt !=
                                          null ||
                                          cubit.timeLineOrderModel!.activeOrder!.shippedAt !=
                                              null
                                          ? color.backgroundColor
                                          : Colors.grey,
                                      borderRadius: BorderRadius.all(
                            ...
                            StepperData(
                              iconWidget: Container(
                                alignment: Alignment.center,
                                decoration: BoxDecoration(
                                    border: cubit.timeLineOrderModel!.activeOrder!.deliveredAt !=
                                        null
                                        ? Border.all(
                                        color: color.primaryColor)
                                        : null,
                      ...
                      if (cubit.timeLineOrderModel!.activeOrder!.orderItems!
                          .isNotEmpty)
                        Text(
                          locale.products,
                          style:
                      ...
                      ListView.separated(
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: BuildContainerType(
                                                          type: cubit.timeLineOrderModel!.activeOrder!.orderItems![index!].product!.type!,
                                                        ),
                                                      ),
                                                    ),
                                                    Positioned(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: Text(
                                                          ...
                                                          cubit.timeLineOrderModel!.activeOrder!.orderItems![index!].product!.productsName!,
                                                          style: font.bodyMedium!.copyWith(
                                                            fontSize: 15.sp,
                                                          ),
                                                        ),
                                                    ...
                                                    Positioned(
                                                      ...
                                                      child: SizedBox(
                                                        ...
                                                        child: FittedBox(
                                                          fit: BoxFit.cover,
                                                          child: Text(
                                                            cubit.timeLineOrderModel!.activeOrder!.orderItems![index!].product!.price!.toString() + ' ${locale.kd}',
                                                            style: font.bodyMedium!.copyWith(
                                                ...
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        cubit.timeLineOrderModel!.activeOrder!.address!,
                                                        style: font.bodyMedium!
                                                            .copyWith(fontSize: 13.sp),
                                                      ),
                                                      SizedBox(
                                                      ...
                                                      BuildGoToLinkRow(
                                                        index: index,
                                                        assign: true,
                                                        link: cubit.timeLineOrderModel!.activeOrder!.location!
                                                        ,),
                                                    ],
                                                  ),
                                                )
                        ...
                        itemCount: cubit.timeLineOrderModel!.activeOrder!
                            .orderItems!.length,
                      ),
                      SizedBox(
                        height: 30.h,
