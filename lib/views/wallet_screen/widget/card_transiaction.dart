...
class BuildCardTransiaction extends StatelessWidget {
  const BuildCardTransiaction({super.key, required this.index});
  final int index;
  @override
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(Helper.formatTimeString(cubit.transiactionModel!
                .transactions![index].userOrder!.createdAt!),
